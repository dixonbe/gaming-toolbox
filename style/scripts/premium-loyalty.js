document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('egmcount').value = 100;
    calculateegmcount();
    calculatemodule1Cost();
    
    document.getElementById('module1count').value = 100;
    calculatemodule1Cost();

    document.getElementById('module2count').value = 501;
    calculatemodule2Cost();

    document.getElementById('module3count').value = 200;
    calculatemodule3Cost();
